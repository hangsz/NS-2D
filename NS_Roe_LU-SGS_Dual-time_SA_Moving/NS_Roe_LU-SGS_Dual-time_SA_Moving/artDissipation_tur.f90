subroutine artDissipation_tur            
    ...
    real(8),allocatable::d2WT(:)                ! the intermediate variable to calculate forth-order difference
    ...
    do i = 1,nedges
        ...
        if( ncr .GT. 0 )  then    !ncr less or equal to zero,the dissipation of this edge is set to zero
            ...
            !the left cell plus the dissipation and the right contrary
