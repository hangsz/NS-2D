subroutine   visFlux   
    !----------------------------------------------------
       ! purpose: calculate the viscous flux using Central Difference shceme
    !----------------------------------------------------
    implicit none
    ...
    real(8)::lamda
    real(8)::txx,tyy,txy,theta_x,theta_y                             !viscous stress
    ...
    do i=1,nedges
        ...
        !----------------------------------------------------
        ! the flow properities gradient of each edge
        select case(ncr)
            
        case(-2:-1)
            
            ! right cell not exist, the gradient is calulated using the boundary and the left cell.
        ...
        case default
            ...
            ! right cell exist, the gradient is calculated using left and right cell
        ...
        ! the molecule and turbulent viscosity are all needed here
        ...
        ! the viscous flux, left plus and right subtract.
        if(ncr.GT. 0) then   
