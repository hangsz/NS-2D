subroutine LU_SGS!( W, U, assigned, lower,upper)   !Lower-Upper Symmetric Successive Overrelexation scheme
    ...
    do i=1,ncells   !it doesn't mean that the sequence is identical to the cell order
        ...
        do j=1,4 
            ...
            !-------------------------------------
            !convective flux, calculate  the lower cells'S_SA n+1 step convective flux 
            ...
            rA = omg*alf(edge) + alf_v(edge)*ds(edge)/lij(edge)
