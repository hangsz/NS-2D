module SST
    ...
    real(8),allocatable:: alf_SST(:) , &   ! ,alf_v_T(:), &          !spectral radius of every edge
                          lamda_SST(:) !,lamda_v_T(:)    !spectral radius of every edge
                          
    real(8),allocatable:: Q_SST(:,:),dQdW_SST(:,:)
    
    real(8),allocatable:: Grad_SST(:,:,:),Grad_W_SST(:,:,:),Fc_SST(:,:),Fv_SST(:,:),Dissi_SST(:,:),Rsi_SST(:,:)
    
    
    real(8),parameter::C1_SST =10.0,C2_SST = 1.0, L_SST = 20.0 
