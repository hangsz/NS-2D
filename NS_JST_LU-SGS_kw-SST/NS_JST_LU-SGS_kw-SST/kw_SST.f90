module kw_SST
    ...
    real(8),parameter::C1 =1.0,C2 = 5.0, L = 20.0 
    real(8),parameter::a1 = 0.31,beta_star = 0.09 , kapa = 0.41
    
    real(8),parameter::sigma_K1 = 0.85 , sigma_omg1 = 0.5 , beta1=0.075  , Cw1 = 0.533
    real(8),parameter::sigma_K2 = 1.0  , sigma_omg2 = 0.856 , beta2=0.0828 , Cw2 = 0.440  
